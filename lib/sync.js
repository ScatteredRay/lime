...
exports.dirtyObjects = dirtyObjects;
...
function addObject(obj, name) {
    console.debug("Added object: ", name);
    syncObjects[name] = obj;
    obj._name = name;
    // TODO: Do we really need to send a create message if we are just going to send an update shortly?
